...
if __name__ == '__main__':
    arg = {}
    # 是否要加载
    arg['load']                   = False       # 加载的原因是： encoder和decoder都是可以BERT预训练的。可以先训练encoder，保存，在预训练decoder。
    arg['load_path']              = 'save_folder/bert_pretrain/e_transformer_token_token_b64_l0.0001_e50/model.chkpt'
    
    # 预训练哪个模块              
    arg['encoder']                = True        # True->encoder    False->decoder                     
    ...
    # 训练后保存的模块
    arg['output_dir']             = 'save_folder/pretrain/e_transformer_token_token_h8_l0.0001_e50/'
    arg['save_mode']              = 'best'   # ['all', 'best']
