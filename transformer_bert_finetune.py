...
def main(arg:dict)->None:
    ...
    transformer = model.Transformer(
        ...
        dropout=arg['dropout'],
        scale_emb_or_prj=arg['scale_emb_or_prj'])
    ...
    transformer = bert.transformer.to(device)
...
if __name__ == '__main__':
    arg = {}
    # 预训练模型路径
    arg['load_path']              = 'save_folder/pretrain/e_d_transformer_token_token_b64_l0.0001_e50/model.chkpt'
  
    # 训练后保存的模块
    arg['output_dir']             = 'save_folder/finetune/e_d_transformer_token_token_l0.00001_e30/'
    arg['save_mode']              = 'all'   
